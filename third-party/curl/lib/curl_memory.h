 ...
 * third-party/curl/include/curl/curl.h and MUST match the originals. We copy them to avoid having to
 * include third-party/curl/include/curl/curl.h here. We avoid that include since it includes stdio.h
