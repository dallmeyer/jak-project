...
static std::vector<ReplaceInfo> s_replace_info_jak2 = {
    ...
    {"~1L~+8H~Y<PAD_PART_STICK>~Z~6L~-16H<PAD_PART_STICK_LEFT>~Z~+16h~6L<PAD_PART_STICK_RIGHT>~Z~"
     ...
     "<PAD_ANALOG_ANY>"},
    {"~1L~+8H~Y<PAD_PART_STICK>~Z~6L~-16H<PAD_PART_STICK_LEFT>~Z~+16h~6L<PAD_PART_STICK_RIGHT>~Z~"
     "6L~-15V<PAD_PART_STICK_UP>~Z~+13V~6L<PAD_PART_STICK_DOWN>~Z~-10H~+9V~6L<PAD_PART_STICK_DOWN_"
     "LEFT>~Z~+10H~+9V~6L<PAD_PART_STICK_DOWN_RIGHT>~Z~-10H~-11V~6L<PAD_PART_STICK_UP_LEFT>~Z~+10H~"
     "-11V~6L<PAD_PART_STICK_UP_RIGHT>~Z~+32H",
     "<PAD_ANALOG_ANY_FIXED>"},
    ...
    {"~Y~1L<PAD_PART_STICK>~Z~6L~-15V<PAD_PART_STICK_DOWN>~Z~+13V~6L<PAD_PART_STICK_UP>~Z~+26H",
     "<PAD_ANALOG_UP_DOWN>"},
    {"~Y~1L<PAD_PART_STICK>~Z~6L~-15V<PAD_PART_STICK_UP>~Z~+13V~6L<PAD_PART_STICK_DOWN>~Z~+26H",
     "<PAD_ANALOG_UP_DOWN_FIXED>"},
